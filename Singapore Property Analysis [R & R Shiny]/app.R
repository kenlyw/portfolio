#packages <- c('sqldf','DT','lubridate','shiny','tidyverse','shinydashboard','readr','dplyr','matrixStats','ggplot2','tidyverse','reshape2','shinyWidgets','plotly','ggrepel',"radarchart","fmsb","bslib","shinythemes")
...
# ----- Importing data
#getwd()
#setwd('C:/Users/User/OneDrive/MITB/ASAR/ASAR Final Project/Shinyapp.io')

# ----- Sources:
# https://population.un.org/wpp/Download/Standard/CSV/
# https://unstats.un.org/unsd/methodology/m49/overview/

#### KENNETH'S CODES START #### 

WB <- read.csv("Combined.csv")
...
life_exp<-read.csv("life_expV2.csv")
fertility<-read.csv("fertilityV2.csv")
GDP<-read.csv("GDPV2.csv")
Edu <-read.csv("EduV2.csv")
...
UNMethod <- read.csv("UNSD - Methodology.csv")
